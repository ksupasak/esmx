...
jQuery(document).ready(function(){
	...
	if(jQuery(this).height() > 480) {
		if(fixed==false){
	    fixed=true;
		jQuery('.mainwrapperheader').addClass('fixed_header');
		jQuery('.mainwrapperinner').addClass('fixed_body');
	}
	}else{
		if(fixed){
		fixed=false;
	...
	jQuery(window).resize(function(){
		...
		if(jQuery(this).width() < 1024) {
			...
			showTooltipLeftMenu();
			jQuery('.mainwrapper').addClass('lefticon');
			jQuery('.mainwrapper').removeClass('div960');
			jQuery('.class_menu').removeClass('div960');
			jQuery('.header').removeClass('div960');
			jQuery('.mainwrapper').addClass('div760');
			jQuery('.class_menu').addClass('div760');
			jQuery('.header').addClass('div760');
			alert('remove')
			jQuery('.main_content').removeClass('shift');
			...
			toggleLeftMenu();
			removeHeaderInner2();
			jQuery('.main_content').addClass('shift');
			jQuery('.mainwrapper').removeClass('lefticon');
			jQuery('.mainwrapper').removeClass('div760');
			jQuery('.mainwrapper').addClass('div960');
			jQuery('.class_menu').removeClass('div760');
			jQuery('.class_menu').addClass('div960');
			jQuery('.header').removeClass('div760');
			jQuery('.header').addClass('div960');
			alert('add')
	...
	if(jQuery(window).width() < 1024) {
		...
		jQuery('.class_menu').removeClass('div960');
		jQuery('.header').removeClass('div960');
		jQuery('.mainwrapper').addClass('760');
		jQuery('.class_menu').addClass('760');
		jQuery('.header').addClass('760');
		jQuery('#togglemenuleft').hide();
		showTooltipLeftMenu();
