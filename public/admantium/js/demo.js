    ...
    eventHistory.add(function(){
        ...
        if(!$('#changeBg')[0]){
            var $bg = $('<div id="changeBg" />').attr('title', 'Change background').css({
                ...
                borderLeft: 'none',
                marginTop: '-80px'
            }).html('<a href="#"><img src="/admantium/img/bg-pattern.png" width="15" height="15" /></a><br /><a href="#"><img src="/admantium/img/bg-pattern-2.png" width="15" height="15" /></a><br /><a href="#"><img src="/admantium/img/bg-pattern-3.png" width="15" height="15" /></a><br /><a href="#"><img src="/admantium/img/bg-pattern-4.png" width="15" height="15" /></a><br /><a href="#"><img src="/admantium/img/bg-pattern-5.png" width="15" height="15" /></a><br /><a href="#"><img src="/admantium/img/bg-pattern-6.png" width="15" height="15" /></a><br /><a href="#"><img src="/admantium/img/bg-pattern-7.png" width="15" height="15" /></a><br /><a href="#"><img src="/admantium/img/bg-pattern-8.png" width="15" height="15" /></a>').appendTo($('body')).find('a').click(function(){
